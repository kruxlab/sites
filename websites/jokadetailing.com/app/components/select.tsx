...
export const Select = forwardRef(function Select(
  {
    ...
    className?: string
    field: FieldMetadata<string | string[] | null | undefined, Record<string, unknown>, string[]>
    multiple?: boolean
  } & Omit<Headless.SelectProps, 'className'>,
  ...
  return (
    <>
      ...
      {field.errors?.map((error) => (
        <ErrorMessage key={error} className='text-red'>{error}</ErrorMessage>
      ))}
    </>
  )
})
